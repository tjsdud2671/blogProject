...
<div class="container">
  ...
  <form name="myform" method="post" action="boardUpdateOk.bo" enctype="multipart/form-data" >
    <table class="table table-bordered">
      ...
      <tr>
        <th>제목</th>
        <td><input type="text" value="${vo.title }" name="title" id="title" placeholder="제목" autofocus required class="form-control"/></td>
      </tr>
       <tr>
       	<th></th>
